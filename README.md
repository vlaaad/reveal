...
```sh
clj -Sdeps '{:deps {vlaaad/reveal {:mvn/version "0.1.0-ea20"}}}' -m vlaaad.reveal.repl
```

#### As a repl in a shell with prepl backend

```sh
clj -Sdeps '{:deps {vlaaad/reveal {:mvn/version "0.1.0-ea20"}}}' -m vlaaad.reveal.prepl
```
...
```sh
clj \
-Sdeps '{:deps {vlaaad/reveal {:mvn/version "0.1.0-ea20"} nrepl {:mvn/version "0.6.0"}}}' \
